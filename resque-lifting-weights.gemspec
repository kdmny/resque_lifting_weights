# -*- encoding: utf-8 -*-
require File.expand_path('../lib/resque-lifting-weights/version', __FILE__)

Gem::Specification.new do |s|
  s.add_development_dependency('rspec', '~> 2.4')
  s.add_development_dependency('yard') 
  
  s.add_test_dependency('resque_unit')
  ...
  s.homepage = 'https://github.com/kdmny/resque-lifting-weights'
  s.name = 'resque-lifting-weights'
